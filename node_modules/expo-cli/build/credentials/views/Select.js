...
class SelectAndroidExperience {
  ...
  async open(ctx) {
    ...
    if (this.androidCredentials.length === 0) {
      var _await$ctx$api$getAsy;

      this.androidCredentials = (_await$ctx$api$getAsy = await ctx.api.getAsync('credentials/android')) === null || _await$ctx$api$getAsy === void 0 ? void 0 : _await$ctx$api$getAsy.credentials;
    }
