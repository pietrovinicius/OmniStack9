...
async function displayAndroidAppCredentials(credentials) {
  ...
  try {
    var _credentials$keystore, _credentials$pushCred;
    ...
    (0, _log().default)('    FCM Api Key: ', (_credentials$pushCred = credentials.pushCredentials) === null || _credentials$pushCred === void 0 ? void 0 : _credentials$pushCred.fcmApiKey, '---------------------');
    (0, _log().default)('\n');
  } catch (error) {
