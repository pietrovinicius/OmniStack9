...
class AppSigningOptInProcess {
  ...
  async run() {
    var _view$credentials, _view$credentials2, _view$credentials3;
    ...
    this.signKeystoreCredentials = {
      ...
      keystorePassword: (_view$credentials = view.credentials) === null || _view$credentials === void 0 ? void 0 : _view$credentials.keystorePassword,
      // @ts-ignore possibly undefined
      keyAlias: (_view$credentials2 = view.credentials) === null || _view$credentials2 === void 0 ? void 0 : _view$credentials2.keyAlias,
      // @ts-ignore possibly undefined
      keyPassword: (_view$credentials3 = view.credentials) === null || _view$credentials3 === void 0 ? void 0 : _view$credentials3.keyPassword
    };
  ...
  async prepareKeystores(username, exp) {
    ...
    this.uploadKeystoreCredentials = await _xdl().AndroidCredentials.generateUploadKeystore(this.uploadKeystore, exp.android.package, `@${username}/${exp.slug}`);
